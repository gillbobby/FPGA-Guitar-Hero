...
/* Definitions for peripheral GPIO_AUDIO_BUTTONS */
#define XPAR_GPIO_AUDIO_BUTTONS_BASEADDR 0x41210000
#define XPAR_GPIO_AUDIO_BUTTONS_HIGHADDR 0x4121FFFF
#define XPAR_GPIO_AUDIO_BUTTONS_DEVICE_ID 0
#define XPAR_GPIO_AUDIO_BUTTONS_INTERRUPT_PRESENT 1
#define XPAR_GPIO_AUDIO_BUTTONS_IS_DUAL 0


/* Definitions for peripheral GPIO_SWITCHES */
#define XPAR_GPIO_SWITCHES_BASEADDR 0x41220000
#define XPAR_GPIO_SWITCHES_HIGHADDR 0x4122FFFF
#define XPAR_GPIO_SWITCHES_DEVICE_ID 1
#define XPAR_GPIO_SWITCHES_INTERRUPT_PRESENT 1
#define XPAR_GPIO_SWITCHES_IS_DUAL 0


/* Definitions for peripheral GPIO_VGA_BUTTONS */
#define XPAR_GPIO_VGA_BUTTONS_BASEADDR 0x41200000
#define XPAR_GPIO_VGA_BUTTONS_HIGHADDR 0x4120FFFF
#define XPAR_GPIO_VGA_BUTTONS_DEVICE_ID 2
#define XPAR_GPIO_VGA_BUTTONS_INTERRUPT_PRESENT 1
#define XPAR_GPIO_VGA_BUTTONS_IS_DUAL 0


/******************************************************************/

/* Canonical definitions for peripheral GPIO_AUDIO_BUTTONS */
#define XPAR_GPIO_0_BASEADDR 0x41210000
#define XPAR_GPIO_0_HIGHADDR 0x4121FFFF
#define XPAR_GPIO_0_DEVICE_ID XPAR_GPIO_AUDIO_BUTTONS_DEVICE_ID
#define XPAR_GPIO_0_INTERRUPT_PRESENT 1
#define XPAR_GPIO_0_IS_DUAL 0

/* Canonical definitions for peripheral GPIO_SWITCHES */
#define XPAR_GPIO_1_BASEADDR 0x41220000
#define XPAR_GPIO_1_HIGHADDR 0x4122FFFF
#define XPAR_GPIO_1_DEVICE_ID XPAR_GPIO_SWITCHES_DEVICE_ID
#define XPAR_GPIO_1_INTERRUPT_PRESENT 1
#define XPAR_GPIO_1_IS_DUAL 0

/* Canonical definitions for peripheral GPIO_VGA_BUTTONS */
#define XPAR_GPIO_2_BASEADDR 0x41200000
#define XPAR_GPIO_2_HIGHADDR 0x4120FFFF
#define XPAR_GPIO_2_DEVICE_ID XPAR_GPIO_VGA_BUTTONS_DEVICE_ID
...
#define XPAR_FABRIC_GPIO_VGA_BUTTONS_IP2INTC_IRPT_INTR 62U
#define XPAR_FABRIC_GPIO_AUDIO_BUTTONS_IP2INTC_IRPT_INTR 63U
#define XPAR_FABRIC_GPIO_SWITCHES_IP2INTC_IRPT_INTR 64U

/******************************************************************/

/* Canonical definitions for Fabric interrupts connected to ps7_scugic_0 */
#define XPAR_FABRIC_TMRCTR_0_VEC_ID XPAR_FABRIC_AXI_TIMER_0_INTERRUPT_INTR
#define XPAR_FABRIC_GPIO_2_VEC_ID XPAR_FABRIC_GPIO_VGA_BUTTONS_IP2INTC_IRPT_INTR
#define XPAR_FABRIC_GPIO_0_VEC_ID XPAR_FABRIC_GPIO_AUDIO_BUTTONS_IP2INTC_IRPT_INTR
#define XPAR_FABRIC_GPIO_1_VEC_ID XPAR_FABRIC_GPIO_SWITCHES_IP2INTC_IRPT_INTR
